...
from tensorflow.keras.layers import Input, Dense, Conv2D, MaxPooling2D, UpSampling2D, Reshape, Lambda, RepeatVector, BatchNormalization, Activation, Dropout
from tensorflow.keras.layers import concatenate, add, Layer, InputSpec
...
class Conv2D_wd(Layer):
	...
	def __init__(self,
				 ...
				 activation=None,
				 use_bias=True,
				 kernel_initializer='glorot_uniform',#change from glorat_uniform
